...
<div class="wsb-canvas body">
	<div class="wsb-canvas-page-container" style="min-height: 100%; padding-top: 0px; position: relative;">
		...
		<div class="wsb-canvas-page page" id="wsb-canvas-template-page" style="height: 1174px; margin: auto; width: 1000px; background-color: #27455b; position: relative;">
		...
		<div class="view-as-mobile" style="padding:10px;position:relative;text-align:center;display:none;">
			<a href="http://www.bhmtherapy.com/#" onclick="return false;">View on Mobile</a>
		</div>
	</div>
</div>
