		 ...
		 <div class="wsb-canvas-page page" id="wsb-canvas-template-page" style="height: 2382px; margin: auto; width: 1000px; background-color: #27455b; position: relative;">
           ...
           ?>
					 ...
					 <!--div class="txt">
						 ...
						 University of Sioux Falls:&nbsp;2003–2007</span></span><br>
						 <br>
						 <span style="font-size:22px;">License</span>&nbsp;<br>
						 <span style="color:#000000;"><span style="font-size:16px;">License:&nbsp;Licensed Professional Counselor – Mental Health (LPC-MH)<br>
						 Licensed By:&nbsp;South Dakota Board of Examiners for Counselors and Marriage and Family Therapists (SDECMFT)<br>
						 Date Issued:&nbsp;June 23, 2009<br>
						 <br>
						 License:&nbsp;Licensed Professional Counselor (LPC)<br>
						 Licensed By:&nbsp;South Dakota Board of Examiners for Counselors and Marriage and Family Therapists (SDECMFT)<br>
						 Date Issued:&nbsp;June 8, 2005</span></span><br>
						 <br>
						 <span style="font-size:22px;">Board Certifications&nbsp;</span><br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;">Certification:&nbsp;Licensed Addiction Counselor (LAC)<br>
						 Certified By:&nbsp;South Dakota Board of Addiction and Prevention Professionals (SDBAPP)<br>
						 Date Issued:&nbsp;November 2013</span></span><br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;"></span></span><br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;">Certification:&nbsp;Certified Chemical Dependency Counselor – III (CCDC – III)<br>
						 Certified By:&nbsp;South Dakota Board of Addiction and Prevention Professionals (SDBAPP)<br>
						 Date Issued:&nbsp;October 2009</span></span><br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;"></span></span><br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;">Certification:&nbsp;Nationally Certified Counselor (NCC)<br>
						 Certified By:&nbsp;National Board for Certified Counselor (NBCC)<br>
						 Date Issued:&nbsp;September 25, 2003</span></span><br></h3>
						 <p><span style="color:#000000;"><span style="font-size:16px;"></span></span><br></p>
						 <p><br></p>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;"></span></span><span style="font-size:22px;">Additional Certifications</span>&nbsp;<br></h3>
						 <h3 class="editor_page_header"><span style="color:#000000;"><span style="font-size:16px;">Certification:&nbsp;Certified Therapist in EMDR<br>
						 Certified By:&nbsp;EMDR International Association (EMDRIA)<br>
						 Date Issued:&nbsp;November 2017<br>
						 <br>
						 Certification:&nbsp;Qualified Mental Health Professionals (QMHP)<br>
						 Certified By:&nbsp;South Dakota Department of Human Services<br>
						 Date Issued:&nbsp;June 1, 2009</span></span><br>
						 <br>
						 <span style="font-size:22px;">Education</span>&nbsp;<span style="font-size:16px;"><br>
						 <span style="color:#000000;">Master of Science Degree Counseling and Human Resource Development<br>
						 Specialization:&nbsp;Agency Counseling<br>
						 College of Education and Human Science<br>
						 South Dakota State University<br>
						 August 2003<br>
						 <br>
						 Bachelor of Science Degree Health and Nutritional Sciences<br>
						 Major:&nbsp;Health Promotion<br>
						 Minor:&nbsp;Human Development and Family Studies<br>
						 College of Education and Human Science<br>
						 South Dakota State University<br>
				 ...
				 <div class="wsb-element-image" data-type="element" id="wsb-element-5edd403b-8603-4072-a836-6da42b8e7aaf">
					 <div class="wsb-image-inner">
						 <div class="img">
							 <a href="https://www.counseling.org/" rel="" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/inc/static/b29e9b460eeec7a80985d0d273696b94.jpg" style="vertical-align:middle;width:218px;height:49px;"></a>
						 </div>
					 </div>
				 </div>
				 <div class="wsb-element-shape" data-type="element" id="wsb-element-2eab6a2d-5259-45c4-a4aa-b6bb3c58ce43">
				 ...
				 <div class="wsb-element-image" data-type="element" id="wsb-element-fba8c944-2bd6-4879-be88-eb8bae5475e3">
					 <div class="wsb-image-inner">
						 <div class="img">
							 <a href="https://www.aamft.org/iMIS15/AAMFT/" rel="" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/inc/static/6de105ea76409c94a1a9bdf700763edb.jpg" style="vertical-align:middle;width:143px;height:57px;"></a>
						 </div>
					 </div>
				 </div>
				 <div class="wsb-element-image" data-type="element" id="wsb-element-ec483699-c234-4b68-a1dd-db188d018637">
					 <div class="wsb-image-inner">
						 <div class="img_hp"><img src="<?php echo get_template_directory_uri(); ?>/inc/static/3bb3a063ef338a3ceea1463432c7697a.jpg" style="vertical-align:middle;width:1920px;height:308px;"></div>
					 </div>
				 </div>
				 <div class="wsb-element-image" data-type="element" id="wsb-element-ea6b35a3-f688-4794-86e5-7e6a3079db8d">
					 <div class="wsb-image-inner">
						 <div class="img">
							 <a href="http://www.emdria.org/" rel="" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/inc/static/295609ce42b3b4ad7f41dad1aa201819.jpg" style="vertical-align:middle;width:116px;height:51px;"></a>
						 </div>
					 </div>
				 </div>
			 </div>
